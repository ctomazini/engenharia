...
def build_operational_health(kpis, centro_atencao, financeiro, include_financial=True):
	vencidos = (kpis.get("parcelas_vencidas") or {}).get("count") or 0 if include_financial else 0
